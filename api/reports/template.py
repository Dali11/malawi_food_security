...
<div class="page">
  ...
  <table>
    ...
    <tr>
      ...
      <td style="color:#2E7D32;font-weight:bold">{summary["spike_events"]["total"] - summary["spike_events"]["critical"] - summary["spike_events"]["severe"] - summary["spike_events"]["moderate"]}</td>
      <td>—</td>
...
<div class="page">
  ...
  <div class="section-intro" style="margin-top:20px">
    ...
    <b>System:</b> frontend-seven-omega-94.vercel.app
  </div>
</div>

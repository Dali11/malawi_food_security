...
export default function DashboardClient() {
  ...
  // Listen for critical badge click from Header
  useEffect(() => {
    function handler() { setSidebarOpen(true) }
    window.addEventListener("mfs:open-alert-sidebar", handler)
    return () => window.removeEventListener("mfs:open-alert-sidebar", handler)
  }, [])
